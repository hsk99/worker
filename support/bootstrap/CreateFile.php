...
class CreateFile
{
    ...
    protected static function onMessageWorkerMan($process)
    {
        ...
        $str .= "                case '1':\n";
        $str .= "                    if (\$url === \"\") {\n";
        $str .= "                        \$controller = parse_name('index', 1);\n";
        $str .= "                        \$action     = parse_name('index');\n";
        $str .= "                    } else {\n";
        $str .= "                        \$controller = parse_name(\$url, 1);\n";
        $str .= "                        \$action     = parse_name(\$url);\n";
        $str .= "                    }\n";
        $str .= "                    \$module = \"\";\n";
        $str .= "                    break;\n";
        $str .= "                case '2':\n";
        ...
        $str .= "                    \$action     = parse_name(\$action, 1, false);\n";
        $str .= "                    break;\n";
        $str .= "                case '3':\n";
        ...
        $str .= "                    case '1':\n";
        $str .= "                        \$module     = \"\";\n";
        $str .= "                        \$controller = parse_name(\$type, 1);\n";
        $str .= "                        \$action     = parse_name(\$type, 1, false);\n";
        $str .= "                        break;\n";
        $str .= "                    case '2':\n";
