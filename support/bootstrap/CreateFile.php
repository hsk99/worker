...
class CreateFile
{
    ...
    protected static function onMessageWorkerMan ($process)
    {
        ...
        $str .= "                case '1':\n\r";
        $str .= "                    if (\$url === \"\") {\n\r";
        $str .= "                        \$url = parse_name('index', 1);\n\r";
        $str .= "                    } else {\n\r";
        $str .= "                        \$url = parse_name(\$url, 1);\n\r";
        $str .= "                    }\n\r";
        $str .= "                    \n\r";
        $str .= "                    if (is_callable(\"\\\App\\\Message\\\\" . $process . "\\\\{\$url}::{\$url}\")) {\n\r";
        $str .= "                        call_user_func(\"\\\App\\\Message\\\\" . $process . "\\\\{\$url}::{\$url}\", \$connection, \$message);\n\r";
        $str .= "                    } else {\n\r";
        ...
        $str .= "                    \n\r";
        $str .= "                    if (is_callable(\"\\\App\\\Message\\\\" . $process . "\\\\{\$controller}::{\$action}\")) {\n\r";
        $str .= "                        call_user_func(\"\\\App\\\Message\\\\" . $process . "\\\\{\$controller}::{\$action}\", \$connection, \$message);\n\r";
        $str .= "                    } else {\n\r";
        $str .= "                        \$connection->send(json(['type'=>'error', 'msg'=>'非法操作！']));\n\r";
        $str .= "                        return;\n\r";
        $str .= "                    }\n\r";
        ...
        $str .= "            }\n\r";
        $str .= "            \n\r";
        $str .= "            \$piece = count(explode('_', \$message_data['type']));\n\r";
        $str .= "            \n\r";
        $str .= "            switch (\$piece) {\n\r";
        $str .= "                case '1':\n\r";
        ...
        $str .= "                    break;\n\r";
        $str .= "                case '2':\n\r";
        $str .= "                    list(\$controller, \$action) = explode('_', \$message_data['type'], 2);\n\r";
        $str .= "                    \$controller = parse_name(\$controller, 1);\n\r";
        $str .= "                    \$action     = parse_name(\$action, 1);\n\r";
        $str .= "                    break;\n\r";
        $str .= "                default:\n\r";
        ...
        $str .= "            \n\r";
        $str .= "            if (is_callable(\"\\\App\\\Message\\\\" . $process . "\\\\{\$controller}::{\$action}\")) {\n\r";
        $str .= "                call_user_func(\"\\\App\\\Message\\\\" . $process . "\\\\{\$controller}::{\$action}\", \$connection, \$message_data);\n\r";
        $str .= "            } else {\n\r";
        $str .= "                \$connection->send(json(['type'=>'error', 'msg'=>'非法操作！']));\n\r";
        $str .= "            }\n\r";
        $str .= "        }\n\r";
    ...
    protected static function onMessageGatewayWorker ($process)
    {
        ...
        $str .= "        \n\r";
        $str .= "        if (is_callable(\"\\\App\\\Message\\\\" . $process . "\\\\{\$controller}::{\$action}\")) {\n\r";
        $str .= "            call_user_func(\"\\\App\\\Message\\\\" . $process . "\\\\{\$controller}::{\$action}\", \$client_id, \$message_data);\n\r";
        $str .= "        } else {\n\r";
        $str .= "            Gateway::sendToClient(\$client_id, json(['type'=>'error', 'msg'=>'非法操作！']));\n\r";
        $str .= "        }\n\r";
        $str .= "    }\n\r";
